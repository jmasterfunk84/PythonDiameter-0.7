...
DIAMETER_APPLICATION_Zh = 16777221;
DIAMETER_APPLICATION_SLg = 16777255;
DIAMETER_APPLICATION_Sh = 16777217;
DIAMETER_APPLICATION_SWm = 16777264;
DIAMETER_APPLICATION_SWx = 16777265;
...
DIAMETER_COMMAND_MULTIMEDIA_AUTH       = 303;
DIAMETER_COMMAND_PROVIDE_LOCATION      = 8388620;
DIAMETER_COMMAND_PROFILE_UPDATE        = 307;
...
#=============================================================================
# 3GPP
DI_3GPP_RAT_TYPE			= 1032;

#=============================================================================
# MAR
DI_3GPP_SIP_AUTH_DATA_ITEM		= 612;
DI_3GPP_SIP_ITEM_NUMBER	        	= 613;
DI_3GPP_SIP_NUMBER_AUTH_ITEMS		= 607;
DI_3GPP_SIP_AUTHENTICATION_SCHEME      	= 608;
DI_3GPP_SIP_AUTHENTICATE     		= 609;
DI_3GPP_SIP_AUTHORIZATION      		= 610;
DI_CONFIDENTIALITY_KEY      		= 625;
DI_INTEGRITY_KEY      			= 626;

DI_GBA_USERSECSETTINGS			= 400;

#=============================================================================
# Sh Application
DI_3GPP_Sh_USER_IDENTITY 		= 700;
DI_3GPP_Sh_PUBLIC_IDENTITY 		= 601;
DI_3GPP_Sh_DATA_REFERENCE 		= 703;
DI_3GPP_Sh_USER_DATA 			= 702;

#=============================================================================
# LRR
DI_3GPP_SLG_LOCATION_TYPE		= 2500;
DI_3GPP_SLG_LCS_EPS_CLIENT_NAME		= 2501;
DI_3GPP_SLG_LCS_REQUESTOR_NAME		= 2502;
DI_3GPP_SLG_LCS_PRIORITY		= 2503;
DI_3GPP_SLG_LCS_QOS			= 2504;

DI_3GPP_SLG_LCS_CLIENT_TYPE             = 1241;
DI_3GPP_SLG_LCS_NAME_STRING             = 1238;
DI_3GPP_SLG_LCS_FORMAT_INDICATOR        = 1237;
DI_3GPP_SLG_LCS_QOS                     = 2504;

DI_3GPP_SLG_LCS_QOS_CLASS		= 2523;
DI_3GPP_SLG_HORIZONTAL_ACCURACY		= 2505;
DI_3GPP_SLG_VERTICAL_ACCURACY		= 2506;
DI_3GPP_SLG_VERTICAL_REQUESTED		= 2507;
DI_3GPP_SLG_RESPONSE_TIME		= 2509;
